...
//	/*初始化DTT11的引脚*/
    ...
    ILI9341_DispStringLine_EN_CH(LINE(0),"这是DHT11上传数据蓝牙程序");
	...
	{	
        ...
        LCD_ClearLine(LINE(1));	/* 清除单行文字 */
        LCD_ClearLine(LINE(2));	/* 清除单行文字 */
				ILI9341_DispStringLine_EN_CH(LINE(1),"Read DHT11 ERROR");
        ILI9341_DispStringLine_EN_CH(LINE(2),"Read DHT11 ERROR");
			}
